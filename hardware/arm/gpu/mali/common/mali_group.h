...
/** @brief power off group.
*
* only set group session to be NULL so that no more activity will happen to this group
* @do_power_change affect if power status need to be change
*/
